...
class Model():
    ...
    def __init__(self):
        ...
        prob_logits = keras.layers.Dense(9, activation="tanh")(l2)
        ...
        self.model.compile(optimizer=keras.optimizers.SGD(config.learning_rate, decay=config.decay, momentum=0.9), loss=[
